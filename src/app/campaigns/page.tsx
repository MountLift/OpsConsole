    ...
    <div className="space-y-8">
      ...
      <form method="GET" className="flex items-center gap-3">
        <div className="relative flex-1">
          <input name="q" defaultValue={query} placeholder="Search campaign name or brand…" className="input pl-9" />
        ...
        {hasFilter && <Link href="/campaigns" className="text-xs text-muted hover:text-amber">Clear</Link>}
      </form>
