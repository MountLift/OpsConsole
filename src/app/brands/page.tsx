  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="card p-4 flex items-center justify-between">
          <div>
            <div className="text-xs text-muted font-medium mb-1">Active & Total Campaigns</div>
      ...
      <form method="GET" className="flex items-center gap-3">
        <div className="relative flex-1">
          <input
            name="q"
            defaultValue={query}
            placeholder="Search brand name, contact person, or email…"
        ...
        {hasFilter && (
          <Link href="/brands" className="text-xs text-muted hover:text-amber">
            Clear
          </Link>
        )}
      </form>
